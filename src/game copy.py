...
class Game:
    ...
    def __init__(self, board: Board, ai: AI):
        ...
        self._human_player = 2  # human goes first by default
        self._ai_player = 1
    ...
    def play_game(self):
        ...
        #    while not self._win:
        #        previous_move = self._player_move()
        #        moves +=1
        #        if not self._win:
        #            self._ai_move(moves, previous_move)
        #            moves +=1
    ...
    def _ai_move(self, moves, previous_move):
        ...
        move = self._ai.next_move(player, moves, previous_move)
